...
(function(){
    ...
    var apis = {
        ...
        getRelatedBooks: {url:baseUri+'book/subject/{id}/related?'+pp},
        getRelatedMovies: {url:baseUri+'movie/subject/{id}/related?'+pp},
        getRelatedMusic: {url:baseUri+'music/subject/{id}/related?'+pp},
